...
class QueueController extends Controller
{
    public function index(): void
    {
        ...
        $inProgress = $this->db->fetchAll("
            SELECT bj.id, bj.status, bj.task_type, bj.queued_at, bj.files_total, bj.files_processed, bj.status_message, SUBSTRING(bj.error_log, 1, 255) as error_log, a.name as agent_name, r.name as repo_name
            FROM backup_jobs bj
